...
class StorageAccount implements AnchorAccount {
  ...
  factory StorageAccount._fromBinary(
    ...
    return StorageAccount._(
      ...
      mobilityType: accountData.mobilityType.toString(),
      movementSpeed: accountData.movementSpeed.toInt(),
      arrivesAt: accountData.arrivesAt.toInt(),
    );
  }
...
class _AccountData with _$_AccountData {
  factory _AccountData({
    ...
    @BString() required String mobilityType,
    @BU64() required BigInt movementSpeed,
    @BU64() required BigInt arrivesAt,
  }) = __AccountData;
